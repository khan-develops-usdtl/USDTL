define(["require", "exports", "tslib", "react", "../../Utilities", "../../utilities/grid/Grid", "./ColorPickerGridCell", "@uifabric/utilities"], function (require, exports, tslib_1, React, Utilities_1, Grid_1, ColorPickerGridCell_1, utilities_1) {
    ...
    var SwatchColorPickerBase = /** @class */ (function (_super) {
        ...
        SwatchColorPickerBase.prototype.render = function () {
            ...
            return (React.createElement(Grid_1.Grid, tslib_1.__assign({}, this.props, { items: this._getItemsWithIndex(colorCells), columnCount: columnCount, onRenderItem: this._renderOption, positionInSet: positionInSet && positionInSet, setSize: setSize && setSize, shouldFocusCircularNavigate: shouldFocusCircularNavigate, doNotContainWithinFocusZone: doNotContainWithinFocusZone, onBlur: this._onSwatchColorPickerBlur, theme: this.props.theme, 
