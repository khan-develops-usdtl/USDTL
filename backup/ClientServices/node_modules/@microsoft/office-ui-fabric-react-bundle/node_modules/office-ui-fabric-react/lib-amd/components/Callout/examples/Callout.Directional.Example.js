define(["require", "exports", "tslib", "react", "office-ui-fabric-react", "./CalloutExample.scss"], function (require, exports, tslib_1, React, office_ui_fabric_react_1) {
    "use strict";
        ...
        CalloutDirectionalExample.prototype.render = function () {
            ...
            return (React.createElement("div", { className: "ms-CalloutExample" },
                ...
                React.createElement("div", { className: "ms-CalloutExample-buttonArea", ref: function (menuButton) { return (_this._menuButtonElement = menuButton); } },
                    React.createElement(office_ui_fabric_react_1.DefaultButton, { className: 'calloutExampleButton', onClick: this._onShowMenuClicked, text: isCalloutVisible ? 'Hide callout' : 'Show callout' })),
                isCalloutVisible ? (React.createElement(office_ui_fabric_react_1.Callout, { className: "ms-CalloutExample-callout", gapSpace: gapSpace, target: this._menuButtonElement, isBeakVisible: isBeakVisible, beakWidth: beakWidth, onDismiss: this._onCalloutDismiss, directionalHint: directionalHint, setInitialFocus: true },
