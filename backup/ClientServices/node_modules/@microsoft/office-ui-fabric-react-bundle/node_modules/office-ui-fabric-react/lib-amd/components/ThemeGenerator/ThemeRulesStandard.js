define(["require", "exports", "../../utilities/color/shades", "../../utilities/color/getColorFromString", "../../Utilities"], function (require, exports, shades_1, getColorFromString_1, Utilities_1) {
    ...
    function themeRulesStandardCreator() {
        ...
        // set default colors for shades (the slot rules were already created above and will be used if the base colors ever change)
        slotRules[BaseSlots[BaseSlots.foregroundColor] + shades_1.Shade[shades_1.Shade.Shade1]].color = getColorFromString_1.getColorFromString('#edebe9');
        slotRules[BaseSlots[BaseSlots.foregroundColor] + shades_1.Shade[shades_1.Shade.Shade2]].color = getColorFromString_1.getColorFromString('#c8c6c4');
        slotRules[BaseSlots[BaseSlots.foregroundColor] + shades_1.Shade[shades_1.Shade.Shade3]].color = getColorFromString_1.getColorFromString('#a19f9d');
        slotRules[BaseSlots[BaseSlots.foregroundColor] + shades_1.Shade[shades_1.Shade.Shade4]].color = getColorFromString_1.getColorFromString('#8a8886');
        slotRules[BaseSlots[BaseSlots.foregroundColor] + shades_1.Shade[shades_1.Shade.Shade5]].color = getColorFromString_1.getColorFromString('#605e5c');
        slotRules[BaseSlots[BaseSlots.foregroundColor] + shades_1.Shade[shades_1.Shade.Shade6]].color = getColorFromString_1.getColorFromString('#3b3a39');
        slotRules[BaseSlots[BaseSlots.foregroundColor] + shades_1.Shade[shades_1.Shade.Shade7]].color = getColorFromString_1.getColorFromString('#201f1e');
