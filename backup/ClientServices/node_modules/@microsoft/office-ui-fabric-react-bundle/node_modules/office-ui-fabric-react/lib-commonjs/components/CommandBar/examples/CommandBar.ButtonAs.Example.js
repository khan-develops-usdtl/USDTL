...
var CustomButton = function (props) {
    ...
    return (React.createElement(Button_1.CommandBarButton, tslib_1.__assign({}, props, { onClick: buttonOnMouseClick, styles: tslib_1.__assign({}, props.styles, itemStyles) })));
};
