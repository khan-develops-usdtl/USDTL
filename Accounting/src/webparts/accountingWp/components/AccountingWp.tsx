...
import styles from './AccountingWp.module.scss'
import { IAccountingWpProps } from './IAccountingWpProps';
...
export default class AccountingWp extends React.Component<IAccountingWpProps, {}> {
  public render(): React.ReactElement<IAccountingWpProps> {
    return (
