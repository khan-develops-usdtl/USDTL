...
export declare const __positioningTestPackage: {
    _finalizePositionData: (positionedElement: IElementPosition, hostElement: HTMLElement, bounds?: Rectangle | undefined, coverTarget?: boolean | undefined, doNotFinalizeReturnEdge?: boolean | undefined) => IPositionedData;
