...
import { css, classNamesFunction, DefaultButton, HighContrastSelector, IconButton, Label } from 'office-ui-fabric-react';
var exampleStyles = {
    twoup: [
    ...
    ButtonSplitExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: css(classNames.twoup) },
            ...
            React.createElement("div", null,
                ...
                React.createElement(DefaultButton, { primary: true, "data-automation-id": "test", disabled: disabled, checked: checked, text: "Create account", onClick: alertClicked, split: true, splitButtonAriaLabel: 'See 2 sample options', "aria-roledescription": 'split button', style: { height: '35px' }, menuProps: {
                        items: [
                            {
                                key: 'emailMessage',
                                text: 'Email message',
            ...
            React.createElement("div", null,
                ...
                React.createElement(DefaultButton, { primary: true, "data-automation-id": "test", disabled: disabled, primaryDisabled: true, checked: checked, text: "Create account", onClick: alertClicked, split: true, splitButtonAriaLabel: 'See 2 sample options', "aria-roledescription": 'split button', style: { height: '35px' }, menuProps: {
                        items: [
                            {
                                key: 'emailMessage',
                                text: 'Email message',
...
var ButtonSplitCustomExample = /** @class */ (function (_super) {
    ...
    ButtonSplitCustomExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(IconButton, { "data-automation-id": "test", disabled: disabled, checked: checked, iconProps: { iconName: 'Upload' }, text: "Create account", onClick: alertClicked, split: true, ariaLabel: "Upload button", splitButtonAriaLabel: 'See 2 sample options', "aria-roledescription": 'split button', styles: customSplitButtonStyles, menuProps: {
                    items: [
                        {
                            key: 'emailMessage',
                            text: 'Email message',
