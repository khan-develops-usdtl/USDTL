 ...
 * of those elements.
 */
export declare type IHTMLSlot = ISlotProp<React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>, React.ReactNode>;
/**
 ...
 */
export declare type IHTMLElementSlot<TElement extends keyof JSX.IntrinsicElements> = ISlotProp<JSX.IntrinsicElements[TElement], React.ReactNode>;
