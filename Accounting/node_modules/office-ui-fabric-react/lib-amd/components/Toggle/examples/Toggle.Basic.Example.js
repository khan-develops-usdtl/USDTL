    ...
    var ToggleBasicExample = /** @class */ (function (_super) {
        ...
        ToggleBasicExample.prototype.render = function () {
            ...
            return (React.createElement("div", { style: { padding: '2px' } },
                ...
                React.createElement(Toggle_1.Toggle, { defaultChecked: true, label: "Enabled and checked (ARIA 1.0 compatible)", onText: "On", offText: "Off", onFocus: function () { return console.log('onFocus called'); }, onBlur: function () { return console.log('onBlur called'); }, onChange: this._onChange, role: "checkbox" })));
        };
