define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Breadcrumb", "office-ui-fabric-react/lib/Label", "../../../common/_exampleStyles.scss", "office-ui-fabric-react/lib/Tooltip", "office-ui-fabric-react/lib/Icon"], function (require, exports, tslib_1, React, Breadcrumb_1, Label_1, exampleStylesImport, Tooltip_1, Icon_1) {
    "use strict";
    ...
    var BreadcrumbBasicExample = /** @class */ (function (_super) {
        ...
        function BreadcrumbBasicExample(props) {
            ...
            _this._getCustomOverflowIcon = function () {
        ...
        BreadcrumbBasicExample.prototype.render = function () {
            return (React.createElement("div", null,
                ...
                React.createElement(Label_1.Label, { className: exampleStyles.exampleLabel, style: { marginTop: '24px' } }, "With Custom Overflow Icon"),
                React.createElement(Breadcrumb_1.Breadcrumb, { items: [
                        { text: 'Files', key: 'Files', onClick: this._onBreadcrumbItemClicked },
                        { text: 'This is folder 1', key: 'f1', onClick: this._onBreadcrumbItemClicked },
                        { text: 'This is folder 2 with a long name', key: 'f2', onClick: this._onBreadcrumbItemClicked },
                        ...
                        { text: 'This is folder 4', key: 'f4', onClick: this._onBreadcrumbItemClicked },
                        { text: 'This is folder 5 another', key: 'f5', onClick: this._onBreadcrumbItemClicked, isCurrentItem: true }
                    ], ariaLabel: 'Breadcrumb with no maxDisplayedItems', onRenderOverflowIcon: this._getCustomOverflowIcon }),
