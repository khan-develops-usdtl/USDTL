define(["require", "exports", "react", "./examples/TeachingBubble.Basic.Example", "./examples/TeachingBubble.Condensed.Example", "./examples/TeachingBubble.Illustration.Example", "./examples/TeachingBubble.WideIllustration.Example", "./examples/TeachingBubble.SmallHeadline.Example", "./examples/TeachingBubble.MultiStep.Example"], function (require, exports, React, TeachingBubble_Basic_Example_1, TeachingBubble_Condensed_Example_1, TeachingBubble_Illustration_Example_1, TeachingBubble_WideIllustration_Example_1, TeachingBubble_SmallHeadline_Example_1, TeachingBubble_MultiStep_Example_1) {
    "use strict";
