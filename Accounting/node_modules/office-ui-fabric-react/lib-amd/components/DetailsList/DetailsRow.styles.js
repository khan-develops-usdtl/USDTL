        ...
        var defaultCellStyles = [
            ...
            classNames.cell,
            {
                ...
                selectors: (_k = {
                    ...
                    _k[IsFocusableSelector] = Styling_1.getFocusStyle(theme, { inset: -1, borderColor: neutralSecondary, outlineColor: white }),
                    _k['&$shimmer'] = {
                        padding: 0,
                        borderLeft: shimmerLeftBorderStyle,
                        borderRight: shimmerRightBorderStyle,
