        ...
        ButtonCommandBarExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                React.createElement("div", { style: { display: 'flex', alignItems: 'stretch', height: '40px' } },
                    ...
                    React.createElement(Button_1.CommandBarButton, { "data-automation-id": "test", disabled: disabled, checked: checked, iconProps: { iconName: 'Add' }, text: "Create account", split: true, splitButtonAriaLabel: 'See 2 sample options', onClick: alertClicked, menuProps: {
                            items: [
                                {
                                    key: 'emailMessage',
                                    name: 'Email message',
