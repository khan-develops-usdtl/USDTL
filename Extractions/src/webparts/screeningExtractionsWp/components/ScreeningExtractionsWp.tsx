...
import styles from './ScreeningExtractionsWp.module.scss';
import { IScreeningExtractionsWpProps } from './IScreeningExtractionsWpProps';
...
export default class ScreeningExtractionsWp extends React.Component<IScreeningExtractionsWpProps, {}> {
  public render(): React.ReactElement<IScreeningExtractionsWpProps> {
    return (
