...
const Layer5 = ({
  ...
  useEffect(() => {
    getFolders(`Shared Documents/${layer1FolderName}/${layer2FolderName}/${layer3FolderName}/${layer4FolderName}/${layer5FolderName}`, sp).then(res => setFolders(res));
  }, []);
  ...
  return (
    <div className={styles.layer5}>
      ...
      <FilesComponent
        folderName={`Shared Documents/${layer1FolderName}/${layer2FolderName}/${layer3FolderName}/${layer4FolderName}/${layer5FolderName}`}
      />
    </div>
  );
};
