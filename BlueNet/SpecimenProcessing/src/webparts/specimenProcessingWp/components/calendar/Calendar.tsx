...
const Calendar = ({ context }) => {
  ...
  const _getEvents = async () => {
    ...
    const calendars = calendarsRes.map((calendar) => ({
      ...
      url: `${siteUrl}/Laboratory/SpecimenProcessing/Lists/Calendar/DispForm.aspx?ID=${calendar.ID}`,
      allDay: true,
    }));
      ...
      <div className={styles.container}>
        <CalendarStyling>
          <FullCalendar
            ...
            dateClick={(info) => {
              window.open("https://usdtl.sharepoint.com/SpecimenProcessing/Lists/Calendar/calendar.aspx");
            }}
          />
        </CalendarStyling>
      </div>
