...
const Layer6 = ({
  ...
  useEffect(() => {
    getFolders(
      `${layer1FolderName}/${layer2FolderName}/${layer3FolderName}/${layer4FolderName}/${layer5FolderName}/${layer6FolderName}`, sp
  ...
  return (
    <div className={styles.layer6}>
      ...
      <FilesComponent
        folderName={`${layer1FolderName}/${layer2FolderName}/${layer3FolderName}/${layer4FolderName}/${layer5FolderName}/${layer6FolderName}`}
      />
    </div>
  );
};
