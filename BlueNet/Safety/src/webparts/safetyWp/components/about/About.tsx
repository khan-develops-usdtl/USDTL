...
const About = ({ context }) => {
  ...
  return (
    <div className={styles.about} style={{ borderBottom: "0.125em solid #e1e1e1", height: 375 }}>
      <div className={styles.heading}>{about.Title.toUpperCase()}</div>
      <div className={styles.container} dangerouslySetInnerHTML={{ __html: about.About }}></div>
    </div>
  );
};
